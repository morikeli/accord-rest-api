...
namespace BusinessServices.BAL.ACORD
{
	...
	/// </summary>
	public class TXLifeRequestOLifERelationHomeOffice :Logger, IProcessXML
	{
        public TXLifeRequestOLifERelationHomeOffice()
		{
		}
			/// <remarks/>
        ...
        private XmlNode GetWritingAgentRelationNode(XmlDocument node)
        {
            ...
            {
                tmpNode = relationnode.SelectSingleNode("//RelationRoleCode[@tc='213']");
                if (tmpNode != null)
