...
namespace BusinessServices.BAL.ACORD
{
	...
	/// </summary>
	public class TXLifeRequestOLifERelationWritingAgent :Logger, IProcessXML
	{
        public TXLifeRequestOLifERelationWritingAgent()
		{
		}
			/// <remarks/>
        ...
        private XmlNode GetWritingAgentRelationNode(XmlDocument node)
        {
            ...
            {
                tmpNode = relationnode.SelectSingleNode("//RelationRoleCode[@tc='37']");
                if (tmpNode != null)
		...
		public bool ProcessXML(XmlNode node)
		{
			try
			{
                ...
                tmpNode = GetWritingAgentRelationNode(xmldoc);
